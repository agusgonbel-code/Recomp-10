(() => {
  ...
  function showRecipe(day,item){
    ...
    const nutritionNote=verified?'<div class="good">Macros verificados ingrediente a ingrediente: las cantidades visibles son exactamente las usadas en el cálculo.</div>':'<div class="notice"><b>Macros de receta, no verificados ingrediente a ingrediente.</b> Los totales se escalan desde la ficha nutricional declarada de la receta. Las cantidades sirven para preparar y ajustar la porción, pero no certifican todavía una suma nutricional reconstruida alimento por alimento.</div>';
