...
const files=[
  'index.html','privacy.html','support.html','manifest.webmanifest','professional-v61.css',
  'persistence.js','date-engine.js','training-engine.js','nutrition-engine.js','expert-coaches-v1.js',
